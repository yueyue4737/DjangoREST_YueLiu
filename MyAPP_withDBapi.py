...
# Program4: import the streaming tweets into mongoDB
# task1: import the .json file
client = MongoClient('localhost', 27017)
db = client.streamingtweets
tweets = db.files
with open('/Users/yue/Desktop/601mini3/Module2_DB/streaming.json') as f:
...
if __name__ == '__main__':
    ...
    sentiment_df.to_csv('sentiment_score.csv')
    # print(len(score))
    # print(len(tweets))
